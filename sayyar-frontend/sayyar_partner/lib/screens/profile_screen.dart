...
class _ProfileScreenState extends State<ProfileScreen>{
  ...
  Future<void> _checkLoginStatus() async {
    ...
    if (authenticated){
      ...
      setState(() {
        Navigator.pushAndRemoveUntil(context, MaterialPageRoute(builder: (_) => const EmployeeLoginScreen()), (Route<dynamic> route) => false,);
      });
    }
  }

  Future<void> fetchUserData() async {
    final url = Uri.parse('http://10.0.2.2:8000/api/users/user-data/employee/');
              ...
              child: Container(
                ...
                child: ListView(
                  children: [
                    ...
                    _infoTile(Icons.work, "Role", data['role'], verified: true),
